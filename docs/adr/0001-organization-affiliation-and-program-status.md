...
at their own events. An award with no registration behind it (grant-first, or
funding a CE registration) falls back to the year anchor, which `#explanation`
labels "no event in view".
